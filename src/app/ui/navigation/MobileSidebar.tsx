...
const navigation = [
  { name: "Visão geral", href: siteConfig.baseLinks.overview, icon: RiHome2Line },
  { name: "Rebanho", href: siteConfig.baseLinks.details, icon: RiListCheck },
  { name: "Configurações", href: siteConfig.baseLinks.settings.general, icon: RiSettings5Line },
] as const
    ...
    <>
      <Drawer>
        ...
        <DrawerContent className="sm:max-w-lg">
          <DrawerHeader>
            <DrawerTitle>Bosque da Alvorada</DrawerTitle>
          </DrawerHeader>
          <DrawerBody>
            <nav
