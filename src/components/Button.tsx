  ...
  variants: {
    variant: {
      primary: [
        ...
        // background color
        'bg-lime-700 dark:bg-lime-700',
        // hover color
        'hover:bg-lime-600 dark:hover:bg-lime-600',
        // disabled
        'disabled:bg-lime-300 disabled:text-white',
        'disabled:dark:bg-lime-800 disabled:dark:text-lime-400',
      ],
      secondary: [
        // border
