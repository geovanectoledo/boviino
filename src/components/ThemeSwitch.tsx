    ...
    >
      <div
        className={cx(
          ...
          "bg-transparent",
          // checked
          "group-data-[state=checked]:bg-gray-400/20 group-data-[state=checked]:text-gray-700 dark:group-data-[state=checked]:bg-gray-400/20 dark:group-data-[state=checked]:text-gray-300",
          // focus
          focusRing,
        )}
      >
