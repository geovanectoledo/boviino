  ...
  return (
    <div
      className={cx(
        ...
        // checked
        "group-data-[state=checked]:border-0 group-data-[state=checked]:border-transparent group-data-[state=checked]:bg-lime-600",
        // disabled
  ...
  return (
    <RadioGroupPrimitives.Item
      ...
      className={cx(
        ...
        "data-[state=checked]:border-lime-600 data-[state=checked]:dark:border-lime-600",
        focusInput,
        className,
      )}
      {...props}
